...
import org.opencb.oskar.analysis.variant.stats.CohortVariantStatsExecutor;
...
public class CohortVariantStatsSparkParquetExecutor extends CohortVariantStatsExecutor implements SparkParquetExecutor {

    public CohortVariantStatsSparkParquetExecutor() {
    }

    public CohortVariantStatsSparkParquetExecutor(ObjectMap executorParams, Path outDir) {
